...
export default function ReqestTracking() {
    ...
    function fnListRequestTracking() {
        ...
        let serverRequestParam = {
            ...
            apiUrl: "/api/v1/listrequesttracking",
            apikey: "LISTREQUEST"
        };
                            ...
                            ctlAttribute.current.map((item, index) => {
                                return (
                                    <View key={index} style={{ width: "100%", padding: 5, borderBottomWidth: 1, borderColor: "#B6F25C", display: "flex", flexDirection: "row" }}>
                                        ...
                                        {
                                            item.activeSts ?
                                                <View style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "30%", height: "auto" }}>
                                                    <Text style={{ color: "white", fontSize: 18, fontWeight: "800" }}>Tracking...</Text>
                                                </View>
                                                :
                                                <View style={{ display: "flex", flexDirection: "row", marginLeft: 10, marginTop: 13, gap: 10 }} >
                                                    <TouchableOpacity
                                                        onPress={() => fnOnPressButtons(item._id, "accept")}
                                                    >
                                                        <Image source={require('../assets/img/tick.png')} style={{ height: 55, width: 55, borderRadius: 10, resizeMode: 'contain', marginVertical: "auto", backgroundColor: "#B6F25C" }} />
                                                    </TouchableOpacity>
                                                    <TouchableOpacity
